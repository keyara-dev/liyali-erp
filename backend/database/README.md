...
PostgreSQL database for Liyali Gateway with 42 tables, 80+ indexes, and 14 sequential migrations.
...
- Admin: `admin@liyali.com` / `password`
- Requester: `requester@liyali.com` / `password`
- Approver: `approver@liyali.com` / `password`
- Finance: `finance@liyali.com` / `password`
