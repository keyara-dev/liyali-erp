-- ============================================================================
-- LIYALI GATEWAY — CONSOLIDATED CORE SCHEMA
...
CREATE TABLE IF NOT EXISTS organizations (
    ...
    -- subscription columns (007, 011)
    trial_start_date     TIMESTAMP WITH TIME ZONE,
    trial_end_date       TIMESTAMP WITH TIME ZONE,
    current_plan_id      UUID,           -- FK to subscription_plans added in 002
    subscription_status  VARCHAR(50)  NOT NULL DEFAULT 'trial',
    billing_cycle_start  TIMESTAMP WITH TIME ZONE,
    billing_cycle_end    TIMESTAMP WITH TIME ZONE,
    grace_period_ends_at TIMESTAMP WITH TIME ZONE,
    max_users_allowed    INTEGER      DEFAULT 50,
    subscription_metadata JSONB       DEFAULT '{}',
    subscription_tier    VARCHAR(255) DEFAULT 'starter',
    created_at           TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at           TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
