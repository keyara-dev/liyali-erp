...
-- Replaces: 002, 008, 026, 031
-- Insert order is FK-safe.
-- Demo orgs pre-populate subscription fields to bypass auto_start_trial trigger
-- (trigger fires only when trial_start_date IS NULL on INSERT).
-- ============================================================================

-- ============================================================================
-- DEMO ORGANIZATIONS
-- The auto_start_trial trigger fires AFTER INSERT when trial_start_date IS NULL.
-- To bypass it, provide a non-NULL trial_start_date in the INSERT, then
-- immediately UPDATE to the final desired 'active' state.
-- ============================================================================
INSERT INTO organizations (
    id, name, slug, description, active,
    tier, subscription_tier, subscription_status,
    current_plan_id, trial_start_date, trial_end_date, max_users_allowed,
    created_at, updated_at
)
SELECT
    'org-demo-001',
    'Liyali Demo Organization',
    'liyali-demo',
    'Default organization for testing and development',
    true,
    'pro', 'pro', 'active',
    id,
...
FROM subscription_plans WHERE slug = 'PRO_PLAN'
...
-- Ensure both orgs are 'active' (not 'trial') — belt-and-suspenders guard
UPDATE organizations SET
    subscription_status  = 'active',
    trial_end_date       = NULL,
    grace_period_ends_at = NULL,
    updated_at           = CURRENT_TIMESTAMP
WHERE id IN ('org-demo-001', 'org-enterprise-001')
...
VALUES
    ('user-super-admin-001', 'superadmin@liyali.com',  'Super Admin',        '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'super_admin', true, NULL,           true,  false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('user-admin-001',       'admin@liyali.com',       'System Administrator','$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin',       true, 'org-demo-001', true,  false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('user-requester-001',   'requester@liyali.com',   'John Requester',     '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'requester',   true, 'org-demo-001', false, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('user-approver-001',    'approver@liyali.com',    'Jane Approver',      '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'approver',    true, 'org-demo-001', false, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('user-finance-001',     'finance@liyali.com',     'Bob Finance',        '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'finance',     true, 'org-demo-001', false, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('user-manager-001',     'manager@liyali.com',     'Alice Manager',      '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'approver',    true, 'org-demo-001', false, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('user-viewer-001',      'viewer@liyali.com',      'Charlie Viewer',     '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'viewer',      true, 'org-demo-001', false, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
ON CONFLICT (id) DO NOTHING;
...
-- ============================================================================
-- GLOBAL SYSTEM ROLES
-- Uses partial-index ON CONFLICT clause matching uk_global_system_role_name.
-- ============================================================================
