...
var SystemPermissions = map[string]Permission{
	...
	"payment_voucher.pay":     {ID: "payment_voucher.pay", Name: "Execute Payment", Description: "Mark payment vouchers as paid / disburse funds (separate from approval)", Resource: "payment_voucher", Action: "pay", Category: "Financial"},
...
var SystemRoles = map[string][]string{
	"super_admin": {
		...
		"payment_voucher.view", "payment_voucher.create", "payment_voucher.edit", "payment_voucher.delete", "payment_voucher.approve", "payment_voucher.pay", "payment_voucher.reject",
	...
	"finance": {
		...
		"payment_voucher.view", "payment_voucher.create", "payment_voucher.edit", "payment_voucher.approve", "payment_voucher.pay", "payment_voucher.reject",
		"vendor.view",
		"category.view",
		"approval.view", "approval.approve", "approval.reject", "approval.comment",
		"analytics.view", "analytics.export",
