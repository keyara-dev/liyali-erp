...
type WorkflowEntityType = 'REQUISITION' | 'BUDGET' | 'PURCHASE_ORDER' | 'GOODS_RECEIVED_NOTE' | 'PAYMENT_VOUCHER' | 'CUSTOM'
...
- [ ] Create `src/app/(private)/workflows/custom/_components/workflow-list.tsx`
...
- [ ] Create `src/app/(private)/workflows/custom/_components/workflow-designer.tsx`
...
- [ ] Create `src/app/(private)/workflows/custom/_components/stage-editor.tsx`
