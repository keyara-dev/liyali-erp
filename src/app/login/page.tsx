      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card rounded-lg shadow-2xl p-8 space-y-6">
          ...
          <div className="text-center space-y-2">
            ...
            <h1 className="text-2xl font-bold text-foreground">Liyali Gateway</h1>
          ...
          <div className="border-t pt-6">
            <h3 className="text-sm font-semibold text-foreground mb-3">Demo Accounts</h3>
            <div className="space-y-2 text-xs">
              ...
              <p className="text-muted-foreground italic pt-2">
                Password: <code className="bg-muted px-2 py-1 rounded text-xs">password123</code>
              </p>
            </div>
          </div>
