        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between bg-blue-50 dark:bg-blue-950/20 p-4 rounded border border-blue-200">
                ...
                <Link href={`/workflows/purchase-orders/${grn.metadata?.poId}`}>
          ...
          <Card>
            ...
            <CardContent className="grid grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="font-bold text-lg">{grn.metadata?.receivedQuantity}</p>
              </div>
              <div>
                  ...
                  <tbody>
                    {(grn.metadata?.items || []).map((item: any) => (
                      <tr key={item.id} className="border-b hover:bg-muted/50">
                        ...
                        <td className="text-right py-3 px-2">{item.poQuantity}</td>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Stage {grn.currentStage} of {grn.totalStages} - Warehouse Manager
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <div>
                ...
                <div className="flex items-center justify-between bg-muted p-3 rounded">
                  <span className="font-medium">
                    Stage {grn.currentStage} of {grn.totalStages}
                  </span>
