...
export function AttachmentPreviewDialog({
  ...
  return (
    <ResponsiveSheet
      ...
      footer={toolbar}
    >
      {/* Viewer — negative margins escape ResponsiveSheet's px-6 pb-4 padding */}
      <div className="h-full overflow-auto bg-muted -mx-6 -mb-4 px-0 flex items-center justify-center">
        {isPDF && (
          <>
            {loadError ? (
