        ...
        <>
            ...
            {mobileMenuOpen && (
                ...
                >
                    ...
                    >
                        <a href="#features" onClick={() => setMobileMenuOpen(false)} className="text-xl text-slate-300 font-medium">Product</a>
                        <a href="#how-it-works" onClick={() => setMobileMenuOpen(false)} className="text-xl text-slate-300 font-medium">How it Works</a>
                        <a href="#pricing" onClick={() => setMobileMenuOpen(false)} className="text-xl text-slate-300 font-medium">Pricing</a>
                        <a href="#about" onClick={() => setMobileMenuOpen(false)} className="text-xl text-slate-300 font-medium">About</a>
                        <hr className="border-slate-800"/>
                        <Link href={isAuthenticated ? "/home" :"/login"}>
                            <button className="bg-primary-600 text-white py-3 rounded-xl font-bold text-lg shadow-lg shadow-primary-500/30 w-full">
                                {isAuthenticated ? "Dashboard" :"Login"}
                            </button>
                        </Link>
                    </motion.div>
