...
export const Hero = () => {
    return (
        <section className="relative pt-40 pb-20 lg:pt-56 lg:pb-32 overflow-hidden bg-slate-50">
            {/* Background Blobs */}
            <motion.div 
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        >
                            <i className="fas fa-sparkles mr-2 text-primary-500"></i>
                        ...
                        >
                            Streamline operations with <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-indigo-600">Liyali Suite</span>
                        </motion.h1>
                        <motion.p 
                        ...
                        >
                            Enhance collaboration and drive growth with the unified platform designed for procurement, workflow automation, and modern team operations.
                        </motion.p>
                        <motion.div 
                        ...
                        >
                            <Link href="/register">
                                <motion.button 
                                    className="w-full sm:w-auto bg-primary-600 hover:bg-primary-700 text-white px-8 py-4 rounded-full font-bold text-lg transition-all shadow-xl shadow-primary-500/30 hover:shadow-primary-500/50 flex items-center justify-center gap-2"
                            ...
                            <motion.button 
                                className="w-full sm:w-auto bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 px-8 py-4 rounded-full font-bold text-lg transition-all hover:shadow-lg flex items-center justify-center gap-2"
                                whileHover={{ y: -2, scale: 1.02 }}
                                whileTap={{ scale: 0.98 }}
                            >
                                <i className="fas fa-play-circle text-primary-500 text-xl"></i> Watch Demo
                            </motion.button>
                        </motion.div>
                        <motion.div 
                        ...
                        >
                            <span className="flex items-center gap-1"><i className="fas fa-check-circle text-green-500"></i> No credit card required</span>
                            <span className="flex items-center gap-1"><i className="fas fa-check-circle text-green-500"></i> 14-day free trial</span>
                        </motion.div>
                    </motion.div>
