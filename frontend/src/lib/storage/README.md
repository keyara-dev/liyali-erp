...
Centralized storage management for the Liyali Gateway application. This folder contains all localStorage operations and serves as the single source of truth for all in-app data until backend APIs are integrated.
...
- `liyali_purchase_orders` - Purchase Order documents
- `liyali_requisitions` - Requisition Form documents
- `liyali_payment_vouchers` - Payment Voucher documents
