...
export function PVApprovalActionPanel({
  ...
  const task = approvalTasks.find((t: any) => t.documentId === pvId);
    ...
    <div className="space-y-4 p-4 bg-primary/5 rounded-lg border border-primary/20">
      <div>
        ...
        <p className="text-sm text-gray-600 mb-4">
          {action === "approve"
            ? "Add a signature and optional comments to approve this payment voucher"
            : "Provide remarks explaining the rejection reason for this payment voucher"}
        </p>
      </div>
      ...
      {action === "approve" ? (
        ...
        <Textarea
          ...
          required
          id="remarks"
          placeholder="Required: Please explain why this payment voucher is being rejected..."
          value={remarks}
