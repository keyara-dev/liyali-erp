          ...
          <Card>
            ...
            <CardContent className="space-y-4">
                  ...
                  {scanResult ? (
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Badge
                          ...
                          className={
                            scanResult.status === "valid" ? "bg-secondary" : ""
                          }
                        >
                    ...
                    <div className="text-center py-4">
                      ...
                      <p className="text-sm text-muted-foreground mt-1">
                        The QR code or document number you entered could not be
                        found in the system.
                      </p>
                    </div>
                  )}
              ...
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-4">
                <p className="text-sm">
                  <span className="font-medium">How it works:</span> Scan the QR
                  code on your document or enter the document number. The system
                  will verify the document's authenticity and show verification
                  details.
                </p>
              </div>
            </CardContent>
