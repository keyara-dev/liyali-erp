        ...
        {canCreate && (
          <Alert>
            ...
            <AlertDescription>
              ...
              The PO will be in draft status and can be edited before submission.
              Suppliers can be attached now or later from the purchase order
              record.
            </AlertDescription>
          </Alert>
        )}
