...
import { verifyDocument, getDocumentForPDF, VerificationResult } from "@/app/_actions/verification";
import {
...
export default function VerificationPage() {
  ...
  const handleVerify = async (e: React.FormEvent) => {
    ...
    setResult(null);
    try {
      const verificationResult = await verifyDocument(documentNumber.trim());
    ...
    <div className="container max-w-4xl py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-1">
          Verify the authenticity of documents using their document number
        </p>
      </div>
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          <form onSubmit={handleVerify} className="flex gap-4">
            <Input
              placeholder="Enter document number (e.g., REQ-260201-78FA)"
              value={documentNumber}
              onChange={(e) => setDocumentNumber(e.target.value)}
              className="flex-1"
            />
            <Button type="submit" disabled={isVerifying || !documentNumber.trim()}>
              {isVerifying ? (
                <>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-green-700">
                            This document is authentic and exists in the system
                          </p>
                        </div>
                      </div>
                    </div>
