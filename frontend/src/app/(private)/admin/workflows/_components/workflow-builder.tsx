...
export function WorkflowBuilder({
  ...
  const [formData, setFormData] = useState<WorkflowFormData>(() => {
    ...
    if (initialData) {
      console.log("Initializing workflow builder with data:", initialData);
  ...
  const handleEditStage = (stageId: string) => {
    console.log("Editing stage with ID:", stageId);
    console.log("Available stages:", formData.stages);
  ...
  const handleSaveStage = (stage: WorkflowStage) => {
    ...
    if (editingStageId) {
      console.log("Updating existing stage:", editingStageId, normalizedStage);
      ...
      console.log("Adding new stage:", normalizedStage);
      ...
      console.log("Created new stage with ID:", newStage.id);
      setFormData({
        ...formData,
