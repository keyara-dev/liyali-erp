    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="border-b border-slate-200 bg-white/50 backdrop-blur-sm sticky top-0">
        <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-slate-900">Liyali Gateway</h1>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mb-10">
          ...
          <p className="text-lg font-medium text-slate-900">{user?.email || 'User'}</p>
        </div>
        ...
        <div>
          <div className="mb-6">
            ...
            <p className="text-sm text-slate-600">Choose where you'd like to work</p>
          </div>
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      isDefault && 'border-blue-500 ring-2 ring-blue-200 ring-offset-2',
                  ...
                  >
                    ...
                    <div className="flex items-start gap-4 mb-3">
                      ...
                      <div className="flex-1">
                        <h3 className="font-semibold text-slate-900 text-base">{org.name}</h3>
                        {org.description && (
                    ...
                    <div className="flex items-center justify-between mt-4 pt-4 border-t border-slate-100">
                      <div className="flex items-center gap-4">
                        <div>
                          ...
                          <p className="text-sm font-medium text-slate-900 capitalize">{org.tier}</p>
                        </div>
                        <div>
